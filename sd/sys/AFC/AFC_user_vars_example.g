...
set global.nozzleDiameterInstalled = 0.6   
...
set global.AFC_prep_switch = {{var.p_s_p^global.AFC_CAN_address^"."^var.p_s[0]},{var.p_s_p^global.AFC_CAN_address^"."^var.p_s[1]},{var.p_s_p^global.AFC_CAN_address^"."^var.p_s[2]},{var.p_s_p^global.AFC_CAN_address^"."^var.p_s[3]}} ; These are the prep switches of each lane
set global.AFC_load_switch = {{var.l_s_p^global.AFC_CAN_address^"."^var.l_s[0]},{var.l_s_p^global.AFC_CAN_address^"."^var.l_s[1]},{var.l_s_p^global.AFC_CAN_address^"."^var.l_s[2]},{var.l_s_p^global.AFC_CAN_address^"."^var.l_s[3]}}        ; These are the load switches of each lane
