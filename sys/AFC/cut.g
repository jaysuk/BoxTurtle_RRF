...
if global.AFC_cut_direction == "left" || global.AFC_cut_direction == "right"
    ...
    set var.pin_park_y_loc = global.AFC_cut_location[1] + (var.location_factor[1] * global.AFC_cut_dist[0])
else
...
M98 P"0:/sys/AFC/debug.g" A"AFC_Cut: Lift Z"
G91
G1 Z5 E-1 F{global.AFC_travel_speed[1]*60}
...
G1 X{var.pin_park_x_loc} Y{var.pin_park_y_loc} F{global.AFC_travel_speed[0]*60}
M98 P"0:/sys/AFC/step_through_macro.g" A{line} A{line}
...
set var.cut_dist = global.AFC_cut_dist[0]+global.AFC_cut_dist[1]
