...
set global.AFC_debug = true

; This sets which features of the load/unload process you want to enable
; They are in the order of brush, cut, kick, park, poop, purge and use measure lengths for load/unload.
set global.AFC_features = {true,true,false,true,false,true,true,true}
...
set global.AFC_cut_dist = {3.0,19.5} ; park (mm) and move (mm)
...
set global.AFC_cut_retract_length = 10 ; Distance (mm)

; This can help prevent clogging of some toolheads by doing a quick tip from to reduce stringing
set global.AFC_cut_quick_tip_forming = true ; true or false
...
set global.AFC_cut_pushback = {5,20} ; Distance (mm) and time to dwell between the pushback
...
set global.AFC_park = {9,102,33} ; Park location in X, Y and Z
...
set global.AFC_lane_loaded = {false,false,false,false}
set global.AFC_lane_first_length = {0,0,0,0}
set global.AFC_lane_total_length = {0,0,0,0}
set global.AFC_lane_continuous = {false,false,false,false}
set global.AFC_lane_filament_type = {"None","None","None","None"}
set global.AFC_lane_filament_type1 = {"None","None","None","None"}

; ########## Additional Info ##########
set global.additional_length = 0
set global.AFC_LED_array = {0,0,0,0}

set global.AFC_time = 0

set global.config_loaded = false

; These are the number of lanes. Calculated on the array count 
set global.AFC_number_of_lanes = #global.AFC_stepper_direction

set global.AFC_extruder_temp = {0,0,0,0}

set global.AFC_step_through_macro = false
...
set global.main_extruder = {var.e_driver,var.e_ms,var.e_spm,var.e_j,var.e_s,var.e_a,var.e_c}    ; This is information about your current extruder. Driver number, microstepping, steps per mm, jerk, max speed, acceleration, current